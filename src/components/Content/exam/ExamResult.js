...
const ExamResult = () => {
  ...
  if (!resultData) {
    return (
      ...
      >
        <div
          style={{ textAlign: 'center', padding: '2rem', background: '#fff', borderRadius: '8px' }}
        >
  ...
  const today = new Date(resultData.takenAt || Date.now()).toLocaleDateString('vi-VN', {
    day: '2-digit',
    month: 'long',
    year: 'numeric',
  });
      ...
      <div className="exam-result-container">
          ...
          <div className="er-score-ring-wrapper">
            <div
              ...
              style={{
                ...
                boxShadow: `0 0 0 6px ${isPassed ? '#dcfce7' : '#fee2e2'}`,
              }}
            >
        ...
        <div className="er-stats">
          <div className="er-stat-card">
            <div className="er-stat-card__label">
              <span>⏱</span> THỜI GIAN
            </div>
          ...
          <div className="er-stat-card">
            <div className="er-stat-card__label" style={{ color: '#16a34a' }}>
              <span>✅</span> CHÍNH XÁC
            </div>
            <div className="er-stat-card__value" style={{ color: '#16a34a' }}>
              {correctCount}
            </div>
            <div className="er-stat-card__sub">Câu trả lời đúng</div>
          </div>
          <div className="er-stat-card">
            <div className="er-stat-card__label" style={{ color: '#dc2626' }}>
              <span>⊗</span> SAI
            </div>
            <div className="er-stat-card__value" style={{ color: '#dc2626' }}>
              {wrongCount}
            </div>
        ...
        >
          ...
          <button className="er-btn-secondary" onClick={() => navigate('/exam/testing-center')}>
            🏠 Quay về trang chủ
          </button>
        </div>
      </div>
