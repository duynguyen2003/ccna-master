...
const StatsCard = ({
  ...
  const renderTrend = () => {
    if (trend === 'up')
      return (
        <span className="admin-stats-trend up">
          <TrendingUp size={14} /> {trendValue}
        </span>
      );
    if (trend === 'down')
      return (
        <span className="admin-stats-trend down">
          <TrendingDown size={14} /> {trendValue}
        </span>
      );
    return (
      <span className="admin-stats-trend neutral">
        <Minus size={14} /> {trendValue || '0%'}
      </span>
    );
  };
  ...
  return (
    <div className="admin-stats-card">
      <div className="admin-stats-card-header">
        ...
        <div
          className="admin-stats-icon-container"
          style={{
